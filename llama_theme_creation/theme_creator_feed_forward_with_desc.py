...
class ThemeCreatorFeedForwardDesc:
    def __init__(self, model="llama3.2-vision:11b-instruct-q4_K_M"):
        ...
        self.system_message = (
            "You are an academic researcher analyzing the themes related to opiate addiction state characterization on social media. You will be given a post, post title and a list of existing themes and descriptions you previously found among related posts. Your task is to analyze the post and identify major themes related to opiate addiction state characterization and give the themes and descriptions you identify. If a theme you identify is not in the list of existing themes add it and a description to the list of themes. If a new theme is similar to a previous theme combine them into a new more general theme and make the description of the theme more general. Only create new themes if you are sure the posts can't be classified with an existing theme. Respond only in the specified format with the major themes related to opiate addiction state characterization and descriptions. Do not include, reasoning, or text in your response."
        )
